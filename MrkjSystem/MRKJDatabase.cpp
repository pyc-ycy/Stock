                            ...
                            , const char *password/*=nullptr*/)
{
    ...
    try {
        // 打开数据库
        //std::string connectionString = "driver={SQL Server};Server=御承扬;Database=MrkjStock;UID=Sa;PWD=953;";
        HRESULT hr = m_pConnection->Open("driver={SQL Server};Server=御承扬;Database=MrkjStock;UID=Sa;PWD=953;","","", adModeUnknown);
        assert(SUCCEEDED(hr));
    }
    catch(_com_error &e) {
